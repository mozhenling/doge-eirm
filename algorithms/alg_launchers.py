...
def make_args_list(n_trials, dataset_names, algorithms, erm_losses, n_hparams_from, n_hparams, steps,
    data_dir, task, holdout_fraction, label_noise_type, label_noise_rate,
            ...
            for algorithm in algorithms:
                ...
                for test_envs in all_test_envs:
                    for hparams_seed in range(n_hparams_from, n_hparams):
                        if algorithm in ['ERM', 'EIRM'] and erm_losses !=[]:
                            for erm_loss in erm_losses:
                                train_args = {}
                                ...
                                train_args['erm_loss'] = erm_loss
                                train_args['label_noise_type'] = label_noise_type
                                train_args['label_noise_rate'] =  label_noise_rate
