...
class ClipLoss(torch.nn.Module):
    """
    LogitClipping
    https://github.com/hongxin001/LogitClip/tree/main
    ...
    def forward(self, logits, targets, temp=1, lp=2):
        delta = 1/temp
...
class ANLoss(torch.nn.Module):
    """
    ActiveNegativeLoss
    https://github.com/Virusdoll/Active-Negative-Loss/tree/main
    [1] X. Ye, X. Li, S. Dai, T. Liu, Y. Sun, and W. Tong, “Active Negative
    Loss Functions for Learning with Noisy Labels,” Advances in Neural Information
    Processing Systems, vol. 36, pp. 6917–6940, Dec. 2023.
    """
    def __init__(self, num_classes, min_prob=1e-7,
    ...
    def active_loss(self, pred, labels):
    ...
    def negative_loss(self, pred, labels):
        # NormalizedNegativeCrossEntropy
