...
#------------------------------------------------------------ Main
########################################################################################################################
#------------------------------------------------------------ re-set imporatant params for each algorithm
if __name__ == "__main__":
    ...
    args.output_dir = os.path.join(args.output_dir, args.dataset + '_test_ids_' + str(args.test_envs) \
                                   + ' label_noise_rate=' + str(args.label_noise_rate))
    ###########################################################################
    # #------------------------------------------------------------ for checkpointing
    """
